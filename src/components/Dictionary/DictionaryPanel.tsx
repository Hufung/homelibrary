...
import { BookOpen, X, Search, Loader2, Volume2, Copy, Check, History } from 'lucide-react';
...
export const DictionaryPanel: React.FC<DictionaryPanelProps> = ({
  ...
  return (
    <div
      id="dict-overlay"
      className="fixed inset-0 z-[60] flex justify-end bg-black/50 backdrop-blur-sm animate-in fade-in duration-200"
      onClick={onClose}
    >
      <aside
